...
import { MOCK_ASTROLOGERS, MOCK_POSTS } from '@/src/mock/data';
...
export default function FeedScreen() {
  ...
  const [posts, setPosts] = useState(MOCK_POSTS.map((p) => ({ ...p, liked: false })));
          ...
          <View key={post.id} style={styles.postCard}>
            ...
            <View style={styles.postHeader}>
              <View style={styles.postAuthorRow}>
                ...
                <View>
                  <Text style={styles.postAuthorName}>{post.astrologerName}</Text>
              ...
              <View style={styles.postHeaderRight}>
                ...
                <TouchableOpacity>
                  <MaterialCommunityIcons name="dots-vertical" size={28} color="#555" />
                </TouchableOpacity>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  scroll: { flex: 1 },
  storiesContainer: { paddingHorizontal: 16, paddingVertical: 16, gap: 20, backgroundColor: '#FFF' },
  storyItem: { alignItems: 'center', width: 64 },
  storyRing: { width: 68, height: 68, borderRadius: 34, borderWidth: 2.5, padding: 2, marginBottom: 5 },
  storyAvatar: { flex: 1, borderRadius: 32, alignItems: 'center', justifyContent: 'center' },
  ...
  postImageArea: { width: SCREEN_WIDTH, minHeight: 320, padding: 24, justifyContent: 'space-between' },
  postContent: { color: '#FFF', fontSize: 16, lineHeight: 26, fontWeight: '500', flex: 1, textAlign: 'center', marginTop: 16 },
  postFooterRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 20 },
  postLogoSmall: { flexDirection: 'row', alignItems: 'center' },
  postLogoAstro: { fontSize: 13, fontWeight: '800', color: '#FFF' },
  postLogoBadge: { backgroundColor: '#FFFFFF30', borderRadius: 3, paddingHorizontal: 5, paddingVertical: 1, marginLeft: 2 },
  ...
  bookBtn: { backgroundColor: '#9d0399', paddingHorizontal: 14, paddingVertical: 6, borderRadius: 6 },
